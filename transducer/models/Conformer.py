"""Conformer components for offline and streaming speech recognition.

This version supports dynamic chunk training, cached streaming context, and
optional attention-free encoder layers.
"""
...
class ConformerEncoder(nn.Module):
    ...
    def forward(
        ...
        """
        if self.use_attention and self.attention_type == "RelPosMHAXL":
            if pos_embs is None:
                raise ValueError(
