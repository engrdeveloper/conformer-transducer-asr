"""Shared Transformer, Conformer, and Branchformer model components.

This module provides the common encoder-decoder interface, attention masks,
positional encoding, and Transformer layers used by the ASR model.
