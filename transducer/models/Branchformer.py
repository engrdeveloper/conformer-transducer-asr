"""Branchformer encoder components for speech recognition.

The encoder combines an attention branch for global context with a
convolutional spatial-gating branch for local context.
